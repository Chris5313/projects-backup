...
// Pass E support: export entity addresses for pointer-to-entity scan
int  GetEntityAddrs(uint64_t* out, int maxN);  // fills out[] with charObj VAs, returns count

// Backpointer scanner - F3: find what points TO our entities
// NO GOING BACK TO HEAP SCAN - THIS FINDS THE REAL ACCESSOR CHAIN
void RunBackpointerScan();

// Forward trace from GameContext - F4: the RIGHT way to find entities
// No heap scanning - follow known static pointers
