...
set "SRCDIR=C:\Users\Shadow\Documents\Projects\Unturned\driver\kmap"
...
echo === Linking ===
"%LINKEXE%" /nologo /nodefaultlib /SUBSYSTEM:NATIVE /DRIVER:WDM /ENTRY:SystemServiceEntry /MERGE:_TEXT=.text /BASE:0x10000 /SAFESEH:NO /PDB:"%OUTDIR%\kmap.pdb" /OUT:"%OUTDIR%\kmap.sys" %WDKLIBS% %MSVCLIBS% %OBJS%
if errorlevel 1 (
    echo LINK FAILED
    exit /b 1
)
